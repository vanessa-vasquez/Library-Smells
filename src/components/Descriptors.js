          ...
          {Object.keys(descriptors).map(word => {
              return (
                  <div className='word' key={word}>
                    <div>
                      {word} {descriptors[word] >= 0 ? "+" : ""}{descriptors[word]}
                    </div>
                    <div className='thumbs-icons'>
                      <Upvote word={word} library={library} descriptors={descriptors} setDescriptors={setDescriptors} />
                      <Downvote word={word} library={library} descriptors={descriptors} setDescriptors={setDescriptors} />
                    </div>
                  </div>
              );
          })}
