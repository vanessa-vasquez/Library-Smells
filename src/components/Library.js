...
export default function Library(props) {
  ...
  return (
    <Container>
        <Row>
            <Col md={4}><div className='name'>{name}</div></Col>
            <Col md={4}></Col>
            <Col md={3}>
                {avgRating && <div className='smell-rating'>{avgRating} star smell</div>}
            </Col>
            <Col md={1}></Col>
        </Row>
        <Row>
        ...
        <Row>
            <Col md={5}>
                ...
                <Descriptors library={name} descriptors={descriptors} setDescriptors={setDescriptors} />
